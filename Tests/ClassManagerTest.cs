...
namespace Tests
{
    public class ClassManagerTest
    {
        ...
        public void AddStudentToClass_ValidIds_ReturnsUpdatedClass()
        {
            ...
            var classEntity = new Class { ClassCode = classCode, Title = "Math", Description = "Math Class", Students = new List<string>() };
        ...
        public void Create_ValidClass_ReturnsCreatedClass()
        {
            ...
            var classEntity = new Class { ClassCode = "class123", Title = "Science", Description = "Science Class", Students = new List<string>() };
